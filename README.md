...
Le [wiki Pim's-CAD](https://github.com/D6BEL9835/Pims-CAD-Updates/wiki) contient les guides illustrés d'installation, d'activation, d'annotation, de carroyage, de talus, de Notes & Calculs, de mise à jour et de dépannage.

Consultez également la [référence complète des commandes ZWCAD](https://github.com/D6BEL9835/Pims-CAD-Updates/wiki/Commandes).
